...
$(document).ready(function(){
	...
	function getReplyAlldata(){
		...
		var url1= '/project2/tour/detail/reply/all/'+trip_no;
		$.getJSON(url1, function(data1){
			...
			var url2= '/project2/tour/detail/reply/person/'+trip_no;
	...
	$('#btn_Create').click(function(){
		...
		if(rtextString == ""){
			...
			$.ajax({
				type: 'post',
				url: '/project2/tour/detail/reply',
				headers:{
	...
	$('#replies').on('click','.reply_list .update_commit',function(){
		...
		$.ajax({
			type:'put',
			url:'/project2/tour/detail/reply/'+update_rno,
			headers:{
				'Content-Type':'application/json',
	...
	$('#replies').on('click','.reply_list .btn_delete',function(){
		...
		if(check == true){
			$.ajax({
				type:'delete',
				url:'/project2/tour/detail/reply/'+rno+'/'+parent,
				headers:{
					'Content-Type':'application/json',
	...
	function getAlldata(){
		...
		var url1 = '/project2/tour/detail/apply/all/'+trip_no;
		$.getJSON(url1, function(data){
			...
			var url2 = '/project2/tour/detail/apply/person/'+trip_no;
	...
	$('#apply_ok').on('click',$(this),function(){
		...
		for(var i=0; i<=rowCnt; i++){
			if(chkObj[i].checked == true){
				...
				$.ajax({
					type:'put',
					url:'/project2/tour/detail/apply/'+1+'/'+no,
					headers:{
						'Content-Type':'application/json',
						'X-Http-Method-Ovveride':'PUT'
					},
...
$('#joinmenu_apply').click(function(){
	...
	if(sessionaut != 0 ){
		...
		if(apply_value){
			...
			$.ajax({
				type:'post',
				url:'/project2/tour/detail/apply/insert/'+trip_no+'/'+mnoString,
				headers:{
					'Content-Type':'application/json',
					'X-HTTP-Method-Override':'POST'
				},
...
$('#context_profile').on('click','.btn_context',function(){
	...
	var url3 = '/project2/tour/detail/apply/profile/'+amno;
	
	$.ajax({
		type:'Get',
		url: '/project2/tour/detail/apply/profile/'+amno,
		headers:{
			'Content-Type':'application/json',
...
$('#profile_button2').click(function(){
	...
	var url = '/project2/mypage/UserPage/'+amno;
	location.href  = url;
});
...
$('#trip_end').click(function(){
	...
	if(check == true){
		$.ajax({
			type:'put',
			url:'/project2/tour/detail/apply/end/'+trip_no,
			headers:{
				'Content-Type':'application/json',
				'X-Http-Method-Ovveride':'PUT'
			},
