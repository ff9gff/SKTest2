...
$(document).ready(function(){
   ...
   function getReplyAlldata(){      
      ...
      var url1= '/project/review/detail/reply/all/'+review_no;
      $.getJSON(url1, function(data1){
         ...
         var url2= '/project/review/detail/reply/person/'+review_no;
   ...
   $('#btn_Create').click(function(){
      ...
      if(rtextString == ""){
         ...
         $.ajax({
            type: 'post',
            url: '/project/review/detail/reply',
            headers:{
   ...
   $('#replies').on('click','.reply_list .update_commit',function(){
      ...
      $.ajax({
         type:'put',
         url:'/project/review/detail/reply/'+update_rno,
         headers:{
            'Content-Type':'application/json',
   ...
   $('#replies').on('click','.reply_list .btn_delete',function(){
      ...
      if(check == true){
         $.ajax({
            type:'delete',
            url:'/project/review/detail/reply/'+rno+'/'+parent,
            headers:{
               'Content-Type':'application/json',
...
$('#context_profile').on('click','.btn_context',function(){   
   ...
   var url3 = '/project/review/detail/reply/profile/'+amno;
   
   $.ajax({
      type:'Get',
      url: '/project/review/detail/reply/profile/'+amno,
      headers:{
         'Content-Type':'application/json',
...
$('#profile_button2').click(function(){
   ...
   var url = '/project/mypage/UserPage/'+amno;
