	...
	console.log(dddd);
		...
		$(document).ready(function() {
				...
				$.getJSON(url, function(datalist) {
					$(datalist).each(function() {
						...
						$.getJSON(urltitle, function(datatitle) {
							...
							var urlregion = '/project/mypage/MyPage/region/' + ${mno};
			...
			function getThumnails_By_ChooseMno() {
				...
				var url2 = '/project/mypage/MyPage/joinlist/' + ${mno};
				$.getJSON(url2, function(data2){
					...
					$(data2).each(function() {
						...
						var urltitle = '/project/mypage/MyPage/jointitle/' + ${mno};
						$.getJSON(urltitle, function(datatitle) {
							$(datatitle).each(function() {
							...
							var urlregion = '/project/mypage/MyPage/joinregion/' + ${mno};
							$.getJSON(urlregion, function(dataregion) {
								$(dataregion).each(function() {
									var name = this.region_name.split(",");
									var tagname = '';
			...
			function getThumnails_By_Review() {
				...
				var url2 = '/project/mypage/MyPage/reviewlist/' + ${mno};
				$.getJSON(url2, function(data2){
					
					$(data2).each(function() {
						ReviewList.push({img_url: this.img_url, content_no: this.content_no, tour: {}, city: {}})
						
						var urltitle = '/project/mypage/MyPage/reviewtitle/' + ${mno};
						$.getJSON(urltitle, function(datatitle) {
							$(datatitle).each(function() {
							...
							var urlregion = '/project/mypage/MyPage/reviewregion/' + ${mno};
							$.getJSON(urlregion, function(dataregion) {
								$(dataregion).each(function() {
									var name = this.region_name.split(",");
									var tagname = '';
